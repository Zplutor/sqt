...
#define __SQT_INDEX_BASE_TYPE_NAME(...) __SQT_INDEX_BASE_TYPE_NAME_(__SQL_UTILITY_JOIN(__VA_ARGS__))

#define __SQT_MAKE_INDEX_TYPE_NAME(NAME) IndexType_##NAME 
#define __SQT_INDEX_TYPE_NAME_(NAME) __SQT_MAKE_INDEX_TYPE_NAME(NAME)
#define __SQT_INDEX_TYPE_NAME(...) __SQT_INDEX_TYPE_NAME_(__SQL_UTILITY_JOIN(__VA_ARGS__))

#define __SQT_MAKE_INDEX_NAME(NAME) Index_##NAME 
#define __SQT_INDEX_NAME_(NAME) __SQT_MAKE_INDEX_NAME(NAME)
#define __SQT_INDEX_NAME(...) __SQT_INDEX_NAME_(__SQL_UTILITY_JOIN(__VA_ARGS__))

#define __SQT_INDEX_NAME_STRING_(NAME) __SQT_UTILITY_STRINGIZE(NAME)
