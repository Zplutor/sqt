...
@details
    ...
    @code
    <TableName>_Index_<Column1><Column2>...
    @endcode
    ...
    public:
        ...
        // The class for the index type, whose name is generated by joining the column names and 
        // appending it to a fixed string "IndexType_".
