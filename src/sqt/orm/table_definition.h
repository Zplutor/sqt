...
@details
    ...
    SQT_COLUMN_FIELD(ID, id)
    SQT_COLUMN_FIELD(Name, name)
    // Define the index with the ID and Name columns.
    SQT_INDEX(ID, Name)
    SQT_TABLE_END
    @endcode
    ...
    public:
        ...
        // The class name of the index type is generated by joining the column names and appending
        // it to a fixed string "IndexType_".
        class IndexType_IDName : 
        ...
        // type. The name of the variable is generated by joining the column names and appending it
        // to a fixed string "Index_".
        IndexType_IDName Index_IDName;
    };
    @endcode
...
/**
Defines an unique index with the specified columns.

@param ...
    The names of the columns that form the unique index. An unique index can be composed of one or
    more columns.
